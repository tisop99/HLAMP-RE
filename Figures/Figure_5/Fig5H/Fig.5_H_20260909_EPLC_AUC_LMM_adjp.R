...
# ---------------------------------------------------------
df <- read.csv(
  "/Users/skylar/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/Ying - Dubois, Frank's files/data/H2/CRISPRi/Incucyte/EPLC272H/stats/samplesheet/20260520_EPLC_samplesheet_complete.csv"
)
...
p_auc <- ggplot(
  ...
  labs(
    title = "EPLC AUC per biological replicate",
    subtitle = paste(
...
pdf(
  file = "/Users/skylar/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/Ying - Dubois, Frank's files/data/H2/CRISPRi/Incucyte/EPLC272H/stats/AUC/20260909_EPLC_AUC_LMM_adjp.pdf",
  paper = "a4",
  height = 70
)
