...
csv_path <- file.path(
  "/Users/skylar/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin",
  "Ying - Dubois, Frank's files/data/H2/Luciferase reporter assay",
  "measurement/MCF7/CCND1 targets/20260417_CCND1E1_MCF7_3biorep_quantification/r",
  "20260908_MCF7_CCND1-E1_reporter_3biorep_quant.csv"
)
...
pdf_path <- file.path(
  out_dir,
  "20260909_CCND1_E1_MCF7_boxplot_log2_paired_ttest_ymax0.pdf"
)
