...
# load profiles
cn_consAmp_BRCA <- readRDS('source_data/cnBased_consensus_ampSum_extendedCohort_EGFR_BRCA_10kb_binned_interpolated.rds')
cn_consAmp_NSCLC <- readRDS('source_data/cnBased_consensus_ampSum_extendedCohort_EGFR_NSCLC_10kb_binned_interpolated.rds')
walks_consAmp_BRCA <- readRDS('source_data/HLAMPwalks_consensus_ampSum_EGFR_BRCA_10kb_binned_interpolated.rds')
walks_consAmp_NSCLC <- readRDS('source_data/HLAMPwalks_consensus_ampSum_EGFR_NSCLC_10kb_binned_interpolated.rds')
