...
consAmp <- readRDS(paste0('HLAMPwalks_consensus_ampSum_',amp,'_',tissue,'_10kb_binned.rds'))
db <- readRDS(paste0('data/joint_HMF_PCAWG_ampSum_walksBased_',amp,'_',tissue,'_T2T_noDuplicates.rds'))
ont <- readRDS(paste0('ONTsamples_uniStrand_HLAMPwalks_ampSum_',amp,'_',tissue,'.rds'))

### complete liftOver holes: 0 coverage from lifted db, but coverage from ont samples
...
saveRDS(consAmp,paste0('HLAMPwalks_consensus_ampSum_',amp,'_',tissue,'_10kb_binned_interpolated.rds'))
